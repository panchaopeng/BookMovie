...
import com.pcp.life.mvvm.vm.item_vm.book.RecycleTopBookItemVM;
...
public class SCBook_LifeViewModel extends BaseViewModel {
    public SCBook_LifeViewModel(@NonNull Application application) {
        super(application);
    }


    //BaseUrl
    public static String baseUrl = "https://api.douban.com/v2/book/search?tag=生活";
    //每页的数据
    ...
    public ItemBinding<ItemViewModel> itemBinding = ItemBinding.of(BR.lifeItem, R.layout.recycle_book_life);
    ...
    private void setBookInfo(List<BookInfo> bookInfo) {
        ...
        for (BookInfo entity : bookInfo) {
            RecycleTopBookItemVM itemViewModel = new RecycleTopBookItemVM(SCBook_LifeViewModel.this, entity);
            //双向绑定动态添加Item
