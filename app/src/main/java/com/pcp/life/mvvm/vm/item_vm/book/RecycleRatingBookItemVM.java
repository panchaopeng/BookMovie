...
public class RecycleRatingBookItemVM extends ItemViewModel<BaseViewModel> {

    public ObservableField<BookInfo> bookInfo = new ObservableField<>();

    public RecycleRatingBookItemVM(@NonNull BaseViewModel viewModel, BookInfo entity) {
        super(viewModel);
