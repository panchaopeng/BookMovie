...
import com.pcp.life.mvvm.vm.item_vm.book.RecycleRatingBookItemVM;
...
public class SCBook_CultureViewModel extends BaseViewModel {

    public SCBook_CultureViewModel(@NonNull Application application) {
        super(application);
    }


    //BaseUrl
    public static String baseUrl = "https://api.douban.com/v2/book/search?tag=文化";
    //每页的数据
    ...
    public ItemBinding<ItemViewModel> itemBinding = ItemBinding.of(BR.cultureItem, R.layout.recycle_book_culture);
    ...
    public void requestNetWork(SmartRefreshLayout smartRefreshLayout, RecyclerView recyclerView) {
    ...
    private void setBookInfo(List<BookInfo> bookInfo) {
        ...
        for (BookInfo entity : bookInfo) {
            RecycleRatingBookItemVM itemViewModel = new RecycleRatingBookItemVM(SCBook_CultureViewModel.this, entity);
            //双向绑定动态添加Item
